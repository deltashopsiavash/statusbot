...
## قابلیت سهمیه دائمی پنل

در این نسخه هنگام افزودن پنل، ربات علاوه بر نام و آدرس پنل، آیدی عددی مالک پنل و سهمیه حجمی بر حسب گیگابایت را می‌پرسد. مثال: برای ۱ ترابایت عدد `1000` را وارد کنید.

بعد از هر بار «استعلام اینباند»، ربات مصرف هر کلاینت را در دیتابیس داخلی ذخیره می‌کند. اگر کلاینت از داخل 3x-ui حذف شود، مصرف ثبت‌شده قبلی از سهمیه کم می‌ماند و به آمار برنمی‌گردد.

از مسیر مدیریت می‌توانید:

- سهمیه گیگ پنل را کم یا زیاد کنید.
- آیدی عددی مالک پنل را تغییر دهید.
- با گزینه «استعلام سهمیه کاربر»، آیدی عددی کاربر را بزنید و کل سهمیه، مصرف ثبت‌شده، باقی‌مانده، کانفیگ‌های موجود و کانفیگ‌های حذف‌شده محفوظ را ببینید.

نکته: چون 3x-ui حذف کانفیگ را به ربات اطلاع نمی‌دهد، برای دقیق شدن مصرف باید هر از چند وقت یک بار «استعلام اینباند» زده شود تا آخرین مصرف‌ها قبل از حذف در دیتابیس ربات ذخیره شوند.
