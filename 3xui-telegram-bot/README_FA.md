...
- این مقدار ادمین اصلی را مشخص می‌کند؛ بعد از بالا آمدن ربات، از داخل «مدیریت → مدیریت ادمین‌ها → افزودن ادمین» می‌توانید ادمین‌های بیشتری اضافه کنید.
...
### ادمین
- `/start`
- منوی «مدیریت» → «مدیریت ادمین‌ها» → «افزودن ادمین» برای اضافه‌کردن ادمین‌های جدید
